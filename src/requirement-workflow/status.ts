...
import { yamlRead, getActiveWorkflow } from './lib/common.js';
...
function showStatus(workflowDir: string, showJson: boolean): void {
  ...
  const riskIcon: Record<string, string> = { normal: '🟢', elevated: '🟡', critical: '🔴' };
  const sizeLabel: Record<string, string> = { tiny: 'Tiny', small: 'Small', medium: 'Medium', large: 'Large' };
