...
- `project-skill-installer` 仅处理安装编排，不直接执行 agent 生成。
- 保持 installer 单一职责：安装流程继续，非 installer 诉求进行路由交付。
...
- 本次输出目录：`/Users/wangyang.learnwy/learnwy/learnwy/skills/project-skill-installer-workspace/iteration-1/eval-3/with_skill/outputs/`
